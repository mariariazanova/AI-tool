...
export function MessageList({ messages, isLoading }: MessageListProps) {
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center px-4 text-center" style={{ minHeight: 'calc(100vh - 220px)' }}>
                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolDescription = getToolDescription(tool.toolName, tool.args);
                            return (
                                ...
                                {tool.state === "result" && tool.result ? (
                                  <>
                                    ...
                                    <div className="flex flex-col">
                                      <span className="text-neutral-700 font-medium">{toolDescription}</span>
                                      <span className="text-neutral-500 font-mono text-[10px]">{tool.toolName}</span>
                                    </div>
                                  </>
                                ) : (
                                  <>
